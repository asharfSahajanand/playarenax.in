...
(async function initDisplayAds() {
  ...
  const adSlots = [
    { adUnit: "/23330730517/playarenax.in_d1", divId: "myw_top_1" },
    { adUnit: "/23330730517/playarenax.in_d2", divId: "myw_top_2" },
    { adUnit: "/23330730517/playarenax.in_d3", divId: "myw_top_3" },
  ];
    ...
    googletag.cmd.push(function () {
      try {
        ...
        currentSlot = googletag
          .defineOutOfPageSlot(
            "/23330730517/playarenax.in_reward",
